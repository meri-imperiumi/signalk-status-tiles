...
Other plugins can ship example tiles for their data. You can discover and add those by clicking the `+` button in the tiles screen (requires logged in status).
